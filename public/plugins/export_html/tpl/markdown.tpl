...
.tab a:hover { border-bottom-color: #d8dee4; }
#tab-html { color: #656d76; }

.content-container .content-html { visibility: hidden; }
.content-container.html .content-markdown { display: none; }
.content-container.html .content-html { display: block; visibility: visible; }
.content-container.html #tab-markdown { color: #656d76; }
.content-container.html #tab-html { color: #0969da; border-bottom-color: #0969da; }

.content-markdown { overflow: auto; white-space: pre-wrap; }
